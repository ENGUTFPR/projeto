...
public class TesteCliente {
    ...
    @Test
    public void TesteValidacaoCPFOK() {
        assertTrue(Util.validacpf("413.235.468-71"));
    }
    
    @Test
    public void TesteValidacaoCPFerro() {
        assertFalse(Util.validacpf("413.235.468-70"));
    }

    @Test
    public void TesteValidacaoDataNascOK() {
    ...
    @Test
    public void TesteValidacaoDataNascErro() {
        DateFormat formatter = new SimpleDateFormat("yyyy-MM-dd");

        Date date;
        try {
            date = (Date) formatter.parse("2016-08-01");
            assertFalse(Util.validarDataNasc(date));
        } catch (ParseException ex) {
            Logger.getLogger(TesteCliente.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public void TesteClienteCadastrado() throws CamposBrancosException {
        ...
        Cliente cli = new Cliente("Teste", "2010-05-01", "412.235.468-81", "", "(43)9167-1350", "", "", "", "", "", "");
